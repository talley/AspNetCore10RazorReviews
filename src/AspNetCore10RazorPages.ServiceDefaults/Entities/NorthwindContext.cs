...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<CountryRegionMapping> CountryRegionMapping { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Country).HasName("PK__CountryR__067B30086D6BBA19");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Human__3214EC071E499B49");
